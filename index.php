...
define('DB_PASSWORD', '1234'); // Your DB Password
define('DB_NAME', 'CSW'); // Your DB Name
                    ...
                    <div class="payment-layout">
                        <div class="qr-code-column">
                            <div class="qr-code-container">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=SimulatedPaymentCourseStoreTotal<?php echo getCartTotal(); ?>" alt="Scan to Pay (Simulated)">
